...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDuplicateEmail(DuplicateEmailException ex) {
        ...
        errorDetail.put("code", "DUPLICATE_EMAIL");
        errorDetail.put("message", ex.getMessage());
        errorDetail.put("details", Map.of("email", ex.getEmail()));

        return buildErrorResponse(HttpStatus.CONFLICT, errorDetail);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleUserNotFound(UserNotFoundException ex) {
        ...
        Map<String, Object> errorDetail = new HashMap<>();
        errorDetail.put("code", "USER_NOT_FOUND");
        errorDetail.put("message", ex.getMessage());
        errorDetail.put("details", Map.of("userId", ex.getUserId()));
