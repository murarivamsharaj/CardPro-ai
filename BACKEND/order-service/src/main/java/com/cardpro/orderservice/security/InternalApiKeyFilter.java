package com.cardpro.orderservice.security;
 ...
 *
 * <p>Used for inter-service communication where other microservices call
 * the order-service with the shared internal API key.
 *
