...
/**
 * Spring Security {@link UserDetails} implementation wrapping the {@link User} entity.
 * Provides authentication-compatible user data including ID, email, and role-based authorities.
 */
@Getter
