  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-white/10 bg-slate-900/50 px-4 backdrop-blur-xl lg:px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        {user?.pro && (
          <span className="inline-flex items-center gap-1 rounded-full border border-amber-400/40 bg-gradient-to-r from-amber-500/15 to-yellow-500/15 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-amber-300">
