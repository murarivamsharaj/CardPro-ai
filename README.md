...
git clone https://github.com/your-org/cardpro-ai.git
cd cardpro-ai
...
|---|---|---|
| discovery-service | `cardpro/discovery-service` | 200 MB |
| gateway-service | `cardpro/gateway-service` | 220 MB |
| auth-service | `cardpro/auth-service` | 250 MB |
| card-service | `cardpro/card-service` | 260 MB |
| lead-service | `cardpro/lead-service` | 240 MB |
| ai-service | `cardpro/ai-service` | 300 MB |
| payment-service | `cardpro/payment-service` | 250 MB |
| frontend | `cardpro/frontend` | 50 MB (Nginx) |
